...
export function Spotlight({ className, fill = 'white' }: SpotlightProps) {
  return (
    <svg
      className={cn(
        'pointer-events-none absolute z-[1] h-[169%] w-[138%] opacity-0 animate-[spotlight_2s_ease_0.75s_1_forwards]',
        className
      )}
    ...
    >
      ...
      <g filter='url(#filter)'>
        <ellipse
          ...
          transform='matrix(-0.822377 -0.168943 -0.168943 0.822377 3631.88 2291.09)'
